...
public class Test {
	...
	public static void main(String[] args) {
		...
		// Compatibilidad de tipos. El tipo producto es compatible con los tipos
		// de sus clases hijas.
		Producto disco1 = new Musica("Portishead", 18.53, 6, true, "Trip Hop");
		Producto disco22 = new Musica("Radiohead", 21.2, 20, true, "Rock");
		...
		// viene del número de veces que se instancia el contructor de Producto
